      ...
      <div className='grid grid-cols-1 gap-5 lg:grid-cols-[1fr_340px]'>
        <div className='flex flex-col gap-5'>
          <Panel padded={false}>
            ...
            <div className='p-5'>
              <div className='mb-4 flex items-center justify-between'>
                <div>
                  ...
                  <div className='text-[12px] text-[color:var(--color-ink-500)]'>
                    Hover a field to see its source. Edits are logged.
                  </div>
                </div>
              ...
              <ul className='divide-y divide-[color:var(--color-line)] rounded-[8px] border border-[color:var(--color-line)]'>
                {extracted.map((f) => (
                  <li
                    className='grid grid-cols-[180px_1fr_140px] items-start gap-3 bg-[color:var(--color-surface)] px-4 py-3'
                    key={f.label}
                  >
                    <div>
                      <div className='text-[12.5px] font-semibold text-[color:var(--color-ink-500)]'>
                        {f.label}
                      </div>
                      <div className='mt-1 text-[11px] text-[color:var(--color-ink-400)]'>
                        {f.source}
                      </div>
                    </div>
                    <div>
                      ...
                      {f.warning && (
                        <div className='mt-1.5 flex items-start gap-1.5 text-[12px] text-[color:var(--color-warning-700)]'>
              ...
              <div className='mt-4 flex items-center justify-between rounded-[8px] border border-[color:var(--color-brand-100)] bg-[color:var(--color-brand-50)] px-4 py-3 text-[12.5px] text-[color:var(--color-brand-900)]'>
                <div className='flex items-start gap-2'>
                  ...
                  <div>
                    <span className='font-semibold'>
                      Proxi recommendation:
                    </span>{' '}
                    Approve with reviewer override on{' '}
                    <span className='font-semibold'>
                      Registered holder
                    </span>{' '}
                    (name variance is legitimate per KYC). Request medallion
          ...
          <div className='grid grid-cols-1 gap-5 md:grid-cols-2'>
            <Panel
              ...
              title='Documents'
            >
              <ul className='flex flex-col divide-y divide-[color:var(--color-line)] -my-4'>
                {documents.map((d) => (
                  <li className='flex items-start gap-3 py-3' key={d.name}>
                    <div className='mt-0.5 flex h-9 w-9 items-center justify-center rounded-[6px] bg-[color:var(--color-surface-sunken)] text-[color:var(--color-ink-700)]'>
            ...
            <Panel subtitle='Identity verification artifacts' title='KYC & identity'>
              <ul className='flex flex-col gap-2'>
                <li className='soft-box flex items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    <Icon
                      className='text-[color:var(--color-positive-500)]'
                      name='shield-check'
                      size={14}
                    />
                    <div>
                      ...
                      <div className='text-[11.5px] text-[color:var(--color-ink-500)]'>
                        Face match · liveness · document authenticity
                      </div>
                    </div>
                  </div>
                ...
                <li className='soft-box flex items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      ...
                      <div className='text-[11.5px] text-[color:var(--color-ink-500)]'>
                        Refinitiv World-Check · 4 variants scored
                      </div>
                    </div>
                  </div>
                ...
                <li className='soft-box flex items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    <Icon
                      className='text-[color:var(--color-warning-500)]'
                      name='alert-triangle'
                      size={14}
                    />
                    <div>
                      ...
                      <div className='text-[11.5px] text-[color:var(--color-ink-500)]'>
                        Stamp cropped · recommend re-upload
                      </div>
                    </div>
                  </div>
                ...
                <li className='soft-box flex items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    <Icon
                      className='text-[color:var(--color-danger-500)]'
                      name='alert-triangle'
                      size={14}
                    />
                    <div>
                      ...
                      <div className='text-[11.5px] text-[color:var(--color-ink-500)]'>
                        On file from 2024 · requested refresh
                      </div>
                    </div>
                  </div>
        ...
        <aside className='flex flex-col gap-5'>
          <Panel title='Decision panel'>
            <div className='mb-4 text-[12px] text-[color:var(--color-ink-500)]'>
              Sensitive action · requires a reason
            </div>
            <div className='flex flex-col gap-3'>
              ...
              <div className='flex items-center justify-between rounded-[8px] border border-[color:var(--color-line)] bg-[color:var(--color-surface-2)] px-3 py-2'>
                <span className='flex items-center gap-2 text-[12.5px] text-[color:var(--color-ink-700)]'>
